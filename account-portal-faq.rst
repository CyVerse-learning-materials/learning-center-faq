...
CyVerse users should update their account information annually for continued access to services. To update, go to the |user.cyverse.org|, log in, and click the |account icon| in the upper right corner. 
